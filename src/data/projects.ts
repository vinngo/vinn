...
export const projects: Project[] = [
  {
    ...
    title: "agentmancy",
    description:
      "A meta-prompting framework that improves performance of your favorite coding agents by generating custom agents and skills. 600+ weekly downloads on npm.",
